...
module.exports = (function () {
  ...
  function gain(data, target, feature) {
    ...
    let entropies = attrVals.map(function (n) {
      ...
      let res = (subset.length / setSize) * e;

      sumOfEntropiesLog += `[ (${subset.length}/${setSize})*B(${numOccurrencesLog}/${subset.length}) ]`;
      numOccurrencesLog = '';
  ...
  function prob(value, list) {
    ...
    numOccurrencesLog = numOccurrences;
    if(SHOWSTEPS) {
      return {
