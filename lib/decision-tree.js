...
module.exports = (function () {
  ...
  function entropyText(probs) {
    let totalTrue = probs.reduce(function (a, b) {
      a = typeof a.value === 'undefined' ? a : a.value === true ? a.numOccurrences : 0;
      b = typeof b.value === 'undefined' ? b : b.value === true ? b.numOccurrences : 0;
      return a + b;
    }, 0);
    let totalElements = probs[0].numElements;
    return `B(${totalTrue}/${totalElements})`;
  }
