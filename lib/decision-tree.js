...
module.exports = (function () {
  ...
  function createTree(data, target, features) {
    ...
    console.log(`Discriminating by ${bestFeatureName} attribute seems to provide us with the most information gain. Therefore selecting ${bestFeatureName} as the ${str} important attribute.`);
    ...
    node.vals = _.map(possibleValues, function (featureVal) {
      ...
      console.log(`for ${bestFeatureName} = ${featureVal} ${str}`);
  ...
  function gain(data, target, feature) {
    ...
    if(SHOWSTEPS) {
      ...
      console.log(workingLog.replaceAll(", \n","\n").replaceAll("][", " + "));
      return res;
    }
